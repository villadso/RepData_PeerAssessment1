...
The mean for the total number of steps per day is: `r meanAll`

The median for the total number of steps per day is: `r medianAll`
...
The `r maxInt`th interval contains the maximum number of steps
...
The mean for the total of steps per day is: `r meanImp`  
The median for the total steps per day is: `r medianImp`  
